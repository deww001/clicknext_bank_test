...
CREATE TABLE `withdrawn` (
  ...
  `accounwithdrawnt_id` varchar(45) DEFAULT NULL,
...
LOCK TABLES `withdrawn` WRITE;
/*!40000 ALTER TABLE `withdrawn` DISABLE KEYS */;
/*!40000 ALTER TABLE `withdrawn` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2023-06-25 18:44:21
